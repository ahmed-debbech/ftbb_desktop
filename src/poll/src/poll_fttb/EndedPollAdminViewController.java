...
@FXML
    private void ctrlpanel(ActionEvent event) throws IOException {
        FXMLLoader fxmlLoader = new FXMLLoader();
            Pane root =  fxmlLoader.load(getClass().getResource("/poll/src/poll_ftbb/FXMLDocument.fxml").openStream());
    ...
    private void ActivePoll(ActionEvent event) throws IOException {
         Parent root1 =  FXMLLoader.load(getClass().getResource("/poll/src/poll_ftbb/PollAdminView.fxml"));
    ...
    private void EndedPoll(ActionEvent event) throws IOException {
            Parent root1 =  FXMLLoader.load(getClass().getResource("/poll/src/poll_ftbb/EndedPollAdminView.fxml"));
            Scene scene = new Scene(root1);
