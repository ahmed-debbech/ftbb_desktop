...
import report_galerie.src.Services.ServiceReport;
...
public class ReportController implements Initializable {
    ...
    private void ShowReports(ActionEvent event) throws SQLException, IOException {
        ...
        ServiceReport sr = new ServiceReport();
           List<Report> list =  sr.ShowReport(Utilities.getClient().getId());
            try{
                
                for(Report r : list){
                    FXMLLoader loader = new FXMLLoader();
                    loader.setLocation(getClass().getResource("/report_galerie/src/ftbb/FXMLreportview.fxml"));
    ...
    private void addreport(ActionEvent event) {
        ...
        if (tfcmd.getText().equals("") || tfemail.getText().equals("") || tfdesc.getText().equals("")) {
            ...
            r.setClient_id(Utilities.getClient().getId());
